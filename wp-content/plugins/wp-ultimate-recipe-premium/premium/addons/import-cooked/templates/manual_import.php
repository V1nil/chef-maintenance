...
<div class="wrap wpurp-import">
    ...
    <form method="POST" action="<?php echo admin_url( 'edit.php?post_type=recipe&page=wpurp_import_cooked_manual' ); ?>">
        ...
        <input type="hidden" name="cooked_tag_category" value="<?php echo $_POST['cooked_tag_category']; ?>">
        <input type="hidden" name="cooked_tag_tags" value="<?php echo $_POST['cooked_tag_tags']; ?>">
        <input type="hidden" name="cooked_tag_cuisine" value="<?php echo $_POST['cooked_tag_cuisine']; ?>">
        <input type="hidden" name="cooked_tag_method" value="<?php echo $_POST['cooked_tag_method']; ?>">

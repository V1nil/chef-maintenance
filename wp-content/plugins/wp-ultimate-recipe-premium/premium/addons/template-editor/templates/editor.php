            ...
            <div id="panel-properties" class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <accordion close-others="true" ng-show="editingBlock!=null">
                        ...
                        <accordion-group heading="Recipe Title" class="panel-info" properties="recipeTitle">
                            <div class="form-group">
                                <label for="tag">Tag</label>
                                <div class="input-group input-group-sm">
                                    <select id="tag" class="form-control" ng-model="template.blocks[editingBlock]['tag']" ng-options="o.id as o.name for o in titleTagOptions">
                        ...
                        <accordion-group heading="Link" class="panel-info" properties="recipeLink">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" ng-model="template.blocks[editingBlock]['recipeLink']"> Output actual link
                                </label>
                            </div>
                            <div class="checkbox" ng-show="template.blocks[editingBlock]['recipeLink']">
                                <label>
                                    <input type="checkbox" ng-model="template.blocks[editingBlock]['recipeLinkTitle']"> Use recipe title as text
                                </label>
                            </div>
                            <div class="checkbox" ng-show="template.blocks[editingBlock]['recipeLink']">
                                <label>
                                    <input type="checkbox" ng-model="template.blocks[editingBlock]['recipeLinkNewPage']"> Opens in new page
                                </label>
                            </div>
                        </accordion-group>

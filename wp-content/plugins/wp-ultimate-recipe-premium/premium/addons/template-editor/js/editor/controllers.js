 ...
 * Main Controller
 */
    .controller('TemplateEditorCtrl', function($scope, $location, $timeout, $http, $sce, $compile, $modal, $filter) {

        $scope.wpLoadDir = $location.search().dir;
         ...
         * Options
         */
        $scope.previewTypeOptions = [{
            id: 'recipe', name: 'Recipe Template' },{
            //id: 'print', name: 'Print Template' },{
            id: 'grid', name: 'Recipe Grid Template' }
        ];
        ...
        $scope.iconNameOptions = [{
            id: 'glyph/basket', name: 'Basket' },{
            id: 'glyph/book-recipe', name: 'Book - Recipes' },{
            id: 'glyph/cutlery', name: 'Cutlery' },{
            id: 'glyph/file', name: 'File' },{
            id: 'glyph/knife', name: 'Knife' },{
            id: 'glyph/oven', name: 'Oven' },{
            id: 'glyph/pan', name: 'Pan' },{
            id: 'glyph/tag', name: 'Tag' }
        ];
                        ...
                        var addToCanvas = function(inCanvas, data, id) {
                            if(jQuery.inArray(id, inCanvas) == -1) {
                                ...
                                if(blocktype != 'container') {
                                    var droppableBlockTypes = ['rows', 'columns', 'table', 'box', 'recipeTags', 'recipeIngredients', 'recipeIngredientContainer', 'recipeInstructions', 'recipeInstructionContainer'];
                                    var block = '';
                                    var parent = '';
        ...
        $scope.openSaveTemplateModal = function () {
            ...
            modalInstance.result.then(function (data) {
                if(data !== undefined) {
                    data.wp_load_dir = $scope.wpLoadDir;
        ...
        $scope.blockDefaults = function(block) {
            ...
            block['fontTransform'] = block['fontTransform'] || 'none'
            ...
            switch (block['type']) {
                ...
                case 'recipeTitle':
                    ...
                    block['text'] = block['text'] || 'Recipe Title'
                    break;
                case 'recipeInstructionContainer':
                    block['actAsList'] = block['actAsList'] !== undefined ? block['actAsList'] : true
                    block['listStyle'] = block['listStyle'] || 'decimal'
                    break;
                case 'recipeIngredientContainer':
                case 'recipeTags':
                    block['actAsList'] = block['actAsList'] !== undefined ? block['actAsList'] : true
                    block['listStyle'] = block['listStyle'] || 'square'
                case 'box':
                    block['text'] = block['text'] || '&nbsp;'
                    break;
                case 'recipeIngredients':
                    block['showGroups'] = block['showGroups'] || 'all'
                    block['showGroupsList'] = block['showGroupsList'] || ''
                    block['text'] = block['text'] || '&nbsp;'
                    break;
                case 'recipeInstructions':
                    block['showGroups'] = block['showGroups'] || 'all'
                    block['recipeInstructionsImages'] = block['recipeInstructionsImages'] !== undefined ? block['recipeInstructionsImages'] : true
                    block['text'] = block['text'] || '&nbsp;'
                    break;
                case 'recipeStars':
                    block['recipeStarsIconFull'] = block['recipeStarsIconFull'] || 'star'
                    block['recipeStarsIconHalf'] = block['recipeStarsIconHalf'] || 'star-half-o'
                    block['recipeStarsIconEmpty'] = block['recipeStarsIconEmpty'] || 'star-o'
                    block['placeholder'] = block['placeholder'] || 'Recipe Stars'
                    break;
                case 'recipeLink':
                    block['recipeLink'] = block['recipeLink'] || false
                    block['recipeLinkTitle'] = block['recipeLinkTitle'] || false
                    block['recipeLinkNewPage'] = block['recipeLinkNewPage'] || false
                    block['placeholder'] = block['placeholder'] || 'Recipe Link'
                    break;
                case 'icon':
                    block['iconName'] = block['iconName'] || 'glyph/cutlery'
                    block['width'] = block['width'] || '24'
                    block['height'] = block['height'] || '24'
                    block['fontColor'] = block['fontColor'] || '#444444'
                    break;
                case 'title':
                    block['tag'] = block['tag'] || 'span'
                ...
                case 'code':
                    ...
                    block['text'] = block['text'] || '';
                    break;
                case 'recipeInstructionImage':
                    block['placeholder'] = block['placeholder'] || 'Recipe Instruction Image';
                case 'recipeImage':
                ...
                case 'printButton':
                    block['icon'] = block['icon'] || 'print';
                    block['placeholder'] = block['placeholder'] || $filter('camelCaseToHuman')(block['type']);
                case 'addtoMealPlan':
                    block['icon'] = block['icon'] || 'calendar';
                    block['placeholder'] = block['placeholder'] || $filter('camelCaseToHuman')(block['type']);
                case 'addToShoppingList':
                    block['icon'] = block['icon'] || 'shopping-cart';
                    block['placeholder'] = block['placeholder'] || $filter('camelCaseToHuman')(block['type']);
                case 'favoriteRecipe':
                    block['icon'] = block['icon'] || 'heart-o';
                    block['iconAlt'] = block['iconAlt'] || 'heart';
                    block['placeholder'] = block['placeholder'] || $filter('camelCaseToHuman')(block['type']);
                ...
                case 'calcium':
                case 'iron':
                    block['nutritionPercentage'] = block['nutritionPercentage'] || false;
                    block['showUnit'] = block['showUnit'] !== undefined ? block['showUnit'] : true;
                    block['placeholder'] = block['placeholder'] || $filter('camelCaseToHuman')(block['type']);
                    break;

                // Social
                case 'twitter':
                    block['socialLayout'] = block['socialLayout'] || 'none';
                    block['placeholder'] = block['placeholder'] || $filter('camelCaseToHuman')(block['type']);
                    break;
                case 'facebook':
                    block['socialLayout'] = block['socialLayout'] || 'button';
                    block['facebookShare'] = block['facebookShare'] || false;
                    block['placeholder'] = block['placeholder'] || $filter('camelCaseToHuman')(block['type']);
                    break;
                case 'google':
                    block['socialLayout'] = block['socialLayout'] || 'medium';
                    block['placeholder'] = block['placeholder'] || $filter('camelCaseToHuman')(block['type']);
                    break;
                case 'pinterest':
                    block['socialLayout'] = block['socialLayout'] || 'none';
                    ...
                    break;
                case 'stumbleupon':
                    block['socialLayout'] = block['socialLayout'] || '4';
                    block['placeholder'] = block['placeholder'] || $filter('camelCaseToHuman')(block['type']);
                    break;
                case 'linkedin':
                    block['socialLayout'] = block['socialLayout'] || '';
                    block['placeholder'] = block['placeholder'] || $filter('camelCaseToHuman')(block['type']);
                    break;
    ...
    .controller('ModalConditionsCtrl', function($scope, $modalInstance, block, conditions) {
        ...
        $scope.fieldOptions = [{
            id: 'recipe_image', name: 'recipe image' },{
            id: 'recipe_post_content', name: 'recipe post content' },{
            id: 'recipe_title', name: 'recipe title' },{
            id: 'recipe_description', name: 'recipe description' },{
            id: 'recipe_rating', name: 'recipe rating' },{
            id: 'recipe_servings', name: 'recipe servings' },{
            id: 'recipe_servings_type', name: 'recipe servings type' },{
            id: 'recipe_prep_time', name: 'recipe prep time' },{
            id: 'recipe_prep_time_text', name: 'recipe prep time unit' },{
            id: 'recipe_cook_time', name: 'recipe cook time' },{
            id: 'recipe_cook_time_text', name: 'recipe cook time unit' },{
            id: 'recipe_passive_time', name: 'recipe passive time' },{
            id: 'recipe_passive_time_text', name: 'recipe passive time unit' },{
            id: 'recipe_ingredients', name: 'recipe ingredients' },{
            id: 'recipe_instructions', name: 'recipe instructions' },{
            id: 'recipe_notes', name: 'recipe notes' },{
            id: 'recipe_nutrition_calories', name: 'calories' },{
            id: 'recipe_nutrition_carbohydrate', name: 'total carbohydrates' },{
            id: 'recipe_nutrition_protein', name: 'protein' },{
            id: 'recipe_nutrition_fat', name: 'total fat' },{
            id: 'recipe_nutrition_saturated_fat', name: 'saturated fat' },{
            id: 'recipe_nutrition_polyunsaturated_fat', name: 'polyunsaturated fat' },{
            id: 'recipe_nutrition_monounsaturated_fat', name: 'monounsaturated fat' },{
            id: 'recipe_nutrition_trans_fat', name: 'trans fat' },{
            id: 'recipe_nutrition_cholesterol', name: 'cholesterol' },{
            id: 'recipe_nutrition_sodium', name: 'sodium' },{
            id: 'recipe_nutrition_potassium', name: 'potassium' },{
            id: 'recipe_nutrition_fiber', name: 'dietary fiber' },{
            id: 'recipe_nutrition_sugar', name: 'sugars' },{
            id: 'recipe_nutrition_vitamin_a', name: 'vitamin A' },{
            id: 'recipe_nutrition_vitamin_c', name: 'vitamin C' },{
            id: 'recipe_nutrition_calcium', name: 'calcium' },{
            id: 'recipe_nutrition_iron', name: 'iron' }
        ];

        $scope.subFieldOptions = [{
            id: 'ingredient_quantity', name: 'ingredient quantity' },{
            id: 'ingredient_unit', name: 'ingredient unit' },{
            id: 'ingredient_name', name: 'ingredient name' },{
            id: 'ingredient_notes', name: 'ingredient notes' },{
            id: 'instruction_text', name: 'instruction text' },{
            id: 'instruction_image', name: 'instruction image' }
        ];

        $scope.settingOptions = [{
            id: 'meal_planner_add_to_meal_plan', name: 'add to meal plan button' },{
            id: 'user_menus_add_to_shopping_list', name: 'add to shopping list button' },{
            id: 'favorite_recipes_enabled', name: 'favorite recipe button' },{
            id: 'recipe_adjustable_servings', name: 'adjustable servings' },{
            id: 'recipe_adjustable_units', name: 'unit conversion' },{
            id: 'recipe_sharing_enable', name: 'recipe sharing' },{
            id: 'recipe_linkback', name: 'link to plugin' },{
            id: 'partners_integrations_bigoven_enable', name: 'BigOven button' },{
            id: 'partners_integrations_chicory_enable', name: 'Chicory button' },{
            id: 'partners_integrations_foodfanatic_enable', name: 'Food Fanatic button' },{
            id: 'partners_integrations_yummly_enable', name: 'Yummly button' }
        ...
        $scope.whenTagOptions = [{
            id: 'in', name: 'selected in' },{
            id: 'not_in', name: 'not selected in' }
        ];
        ...
        $scope.addTagCondition = function() {
            var condition = {
                condition_type: 'tag',
                target: 'block',
                term: '',

...
class WPURP_Template_Container extends WPURP_Template_Block {
    ...
    public function output( $recipe, $args = array() )
    {
        ...
        $metadata = WPUltimateRecipe::option( 'recipe_metadata_type', 'json' ) == 'json' ? WPUltimateRecipe::get()->helper( 'metadata' )->get_metadata( $recipe ) : '';
        $meta = WPUltimateRecipe::option( 'recipe_metadata_type', 'json' ) == 'inline' && ( $args['template_type'] == 'recipe' || $args['template_type'] == 'metadata' ) ? ' itemscope itemtype="http://schema.org/Recipe"' : '';
        ...
        ob_start();
?>
<div<?php echo $meta; ?> id="wpurp-container-recipe-<?php echo $recipe->ID(); ?>"
     data-id="<?php echo $recipe->ID(); ?>"
     data-permalink="<?php echo $recipe->link(); ?>"
...
<?php if( WPUltimateRecipe::option( 'recipe_metadata_type', 'json' ) == 'inline' && ( $args['template_type'] == 'recipe' || $args['template_type'] == 'metadata' ) ) { ?>
...
<?php if( WPUltimateRecipe::option( 'recipe_metadata_type', 'json' ) == 'inline' && $args['template_type'] == 'metadata' ) { ?>

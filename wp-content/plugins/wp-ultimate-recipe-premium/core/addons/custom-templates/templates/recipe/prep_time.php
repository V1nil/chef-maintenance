...
class WPURP_Template_Recipe_Prep_Time extends WPURP_Template_Block {
    ...
    public function output( $recipe, $args = array() )
    {
        ...
        $meta = WPUltimateRecipe::option( 'recipe_metadata_type', 'json' ) == 'inline' && $args['template_type'] == 'recipe' && $args['desktop'] && $recipe->prep_time_meta() ? '<meta itemprop="prepTime" content="' . $recipe->prep_time_meta() . '">' : '';

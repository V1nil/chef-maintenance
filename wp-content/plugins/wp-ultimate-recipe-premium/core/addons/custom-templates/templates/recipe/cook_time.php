...
class WPURP_Template_Recipe_Cook_Time extends WPURP_Template_Block {
    ...
    public function output( $recipe, $args = array() )
    {
        ...
        $meta = WPUltimateRecipe::option( 'recipe_metadata_type', 'json' ) == 'inline' && $args['template_type'] == 'recipe' && $args['desktop'] && $recipe->cook_time_meta() ? '<meta itemprop="cookTime" content="' . $recipe->cook_time_meta() . '">' : '';
